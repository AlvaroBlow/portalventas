...
<html lang="en">
  <head>
    ...
    <title>Aconcagua Foods - Inicio</title>
    <!-- Fonts-->
...
<?php include("menu.php"); ?>
    ...
    <main class="ps-main">
      ...
      <div class="ps-section--features-product ps-section masonry-root pt-100 pb-100">
        <div class="ps-container">
          <div class="ps-section__header mb-50">
            <h3 class="ps-section__title" data-mask="Descatacados">- Productos Destacados</h3>
            <ul class="ps-masonry__filter">
              <li class="current"><a href="#" data-filter="*">Todos <sup>8</sup></a></li>
              <li><a href="#" data-filter=".Conservas">Conservas <sup>1</sup></a></li>
              <li><a href="#" data-filter=".Salsas">Salsas <sup>1</sup></a></li>
            </ul>
          </div>
                  ...
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail">
                        <div class="ps-badge"><span>Nuevo</span></div>
                      ...
                      <div class="ps-shoe__content">
                        ...
                        <div class="ps-shoe__detail"><a class="ps-shoe__name" href="#">Salsa de tomates con carne</a>
                          <p class="ps-shoe__categories"><a href="#">Salsas</a></p><span class="ps-shoe__price">
                  ...
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      ...
                      <div class="ps-shoe__content">
                        ...
                        <div class="ps-shoe__detail"><a class="ps-shoe__name" href="#">Durazno en Cubitos</a>
                          <p class="ps-shoe__categories"><a href="#">Conservas</a>,<a href="#"> Duraznos</a></p><span class="ps-shoe__price"> $ 120</span>
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="grid-item Salsas">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      ...
                      <div class="ps-shoe__content">
                        ...
                        <div class="ps-shoe__detail"><a class="ps-shoe__name" href="#">Salsa de tomates Natural</a>
                          <p class="ps-shoe__categories"><a href="#">Salsas</a></p><span class="ps-shoe__price"> $ 120</span>
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="grid-item Arvejas Conservas">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail">
                      ...
                      <div class="ps-shoe__content">
                        ...
                        <div class="ps-shoe__detail"><a class="ps-shoe__name" href="#">Arvejas en Conserva</a>
                          <p class="ps-shoe__categories"><a href="#">Arvejas</a>,<a href="#"> Conserva</a></p><span class="ps-shoe__price">
                            <del>$220</del> $ 120</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      ...
                      <div class="ps-shoe__content">
                        ...
                        <div class="ps-shoe__detail"><a class="ps-shoe__name" href="#">Cerezas en Conserva</a>
                          <p class="ps-shoe__categories"><a href="#">Cerezas</a>,<a href="#"> Conservas</a></p><span class="ps-shoe__price"> $ 120</span>
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="grid-item Conserva">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      ...
                      <div class="ps-shoe__content">
                        ...
                        <div class="ps-shoe__detail"><a class="ps-shoe__name" href="#">Durazno en Cubitos</a>
                          <p class="ps-shoe__categories"><a href="#">Duraznos</a>,<a href="#"> Conservas</a></p><span class="ps-shoe__price"> $ 120</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      ...
                      <div class="ps-shoe__content">
                        ...
                        <div class="ps-shoe__detail"><a class="ps-shoe__name" href="#">Salsa de Tomates Italiana</a>
                          <p class="ps-shoe__categories"><a href="#">Salsas</a></p><span class="ps-shoe__price"> $ 120</span>
                        </div>
                      </div>
                    </div>
      ...
      <div class="ps-section--sale-off ps-section pt-80 pb-40">
        <div class="ps-container">
          <div class="ps-section__header mb-50">
            <h3 class="ps-section__title" data-mask="Sale off">- Mayores Ventas Hoy</h3>
          </div>
          <div class="ps-section__content">
            <div class="row">
                  <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                    <div class="ps-hot-deal">
                      <h3>Salsa Italiana</h3>
                      <p class="ps-hot-deal__price">Only:  <span>$155</span></p>
                      <ul class="ps-countdown" data-time="December 13, 2017 15:37:25">
                        <li><span class="hours"></span><p>Hora</p></li>
                        <li class="divider">:</li>
                        <li><span class="minutes"></span><p>minutos</p></li>
                        <li class="divider">:</li>
                        <li><span class="seconds"></span><p>Segundos</p></li>
                      </ul><a class="ps-btn" href="#">Orderenes de hoy<i class="ps-icon-next"></i></a>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
          ...
          <div class="ps-section__header mb-50">
            <div class="row">
                  <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
                    <h3 class="ps-section__title" data-mask="Más Vendidos">- Más vendidos</h3>
                  </div>
          ...
          <div class="ps-section__content">
            <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="30" data-owl-nav="false" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="1" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-duration="1000" data-owl-mousedrag="on">
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>Nuevos</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="images/shoe/1.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.php"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="images/shoe/2.jpg" alt=""><img src="images/shoe/3.jpg" alt=""><img src="images/shoe/4.jpg" alt=""><img src="images/shoe/5.jpg" alt=""></div>
                    ...
                    <div class="ps-shoe__detail"><a class="ps-shoe__name" href="product-detai.php">Salsa de Tomates con Carne</a>
                      <p class="ps-shoe__categories"><a href="#">Salsas</a></p><span class="ps-shoe__price"> $ 120</span>
                    </div>
                  </div>
                </div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  ...
                  <div class="ps-shoe__content">
                    ...
                    <div class="ps-shoe__detail"><a class="ps-shoe__name" href="product-detai.php">Durazno Cubitos</a>
                      <p class="ps-shoe__categories"><a href="#">Conservas</a>,<a href="#"> Duraznos</a></p><span class="ps-shoe__price">
                        <del>$220</del> $ 120</span>
                    </div>
                  </div>
                </div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  ...
                  <div class="ps-shoe__content">
                    ...
                    <div class="ps-shoe__detail"><a class="ps-shoe__name" href="product-detai.php">Salsa Tomate Natural</a>
                      <p class="ps-shoe__categories"><a href="#">Salsas</a></p><span class="ps-shoe__price"> $ 120</span>
                    </div>
                  </div>
                </div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  ...
                  <div class="ps-shoe__content">
                    ...
                    <div class="ps-shoe__detail"><a class="ps-shoe__name" href="product-detai.php">Arvejas en Conserva</a>
                      <p class="ps-shoe__categories"><a href="#">Arvejas</a>,<a href="#"> Conservas</a></p><span class="ps-shoe__price"> $ 120</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  ...
                  <div class="ps-shoe__content">
                    ...
                    <div class="ps-shoe__detail"><a class="ps-shoe__name" href="product-detai.php">Cerezas Enteras</a>
                      <p class="ps-shoe__categories"><a href="#">Cerezas</a>,<a href="#"> Conservas</a></p><span class="ps-shoe__price"> $ 120</span>
                    </div>
                  </div>
                </div>
          ...
          <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on" data-owl-animate-in="fadeIn" data-owl-animate-out="fadeOut">
            <div class="ps-testimonial">
              ...
              <header>
                ...
                <p>Aconcagua Foods - Misión</p>
              </header>
              <footer>
                <p>“Aportar valor e innovación en cada una de nuestras categorías y marcas para contribuir positivamente a nuestros clientes, consumidores, comunidad, productores y colaboradores.“</p>
              </footer>
            </div>
      ...
      <div class="ps-home-contact">
        ...
        <div class="ps-home-contact__form">
          <header>
            ...
            <p>Conozca el perfil de nuestra empresa, el impacto en la comunidad, la motivación sostenible y más.</p>
          </header>
          <footer>
            <form action="product-listing.php" method="post">
              ...
              <div class="form-group">
                <label>Su Mensaje<span>*</span></label>
                <textarea class="form-control" rows="4"></textarea>
              </div>
              <div class="form-group text-center">
                <button class="ps-btn">Enviar Mensaje<i class="fa fa-angle-right"></i></button>
              </div>
            </form>
          </footer>
        </div>
